  Pod::Spec.new do |spec|
    ...
    spec.source       = {:http =>  "https://github.com/fpazarbas/EnVerify/archive/refs/tags/1.0.27.zip"}
    spec.ios.vendored_frameworks = "EnVerify-1.0.27/EnVerify.framework"
    spec.ios.framework = "EnVerify-1.0.27/EnVerify"
